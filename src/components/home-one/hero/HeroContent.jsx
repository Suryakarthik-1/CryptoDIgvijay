...
function HeroContent() {
    ...
    <div className="aximo-hero-content">
      <FadeInStaggerTwo>
        ...
        <FadeInStaggerTwoChildren>
          <p>
            Ready to take your crypto trading to the next level? <br></br>We
            equip you with the knowledge and tools to navigate the exciting
            world of crypto and achieve your financial goals. Join our community
            of successful traders today!
          </p>
        </FadeInStaggerTwoChildren>
        <FadeInStaggerTwoChildren>
          <div className="aximo-hero-user-wrap">
            ...
            <div className="aximo-hero-user-data">
              <p>Believed by thousands of people</p>
            </div>
          </div>
        </FadeInStaggerTwoChildren>
        <FadeInStaggerTwoChildren>
          <Link className="aximo-call-btn" to="/contact-us">
            Get in touch with us! <i className="icon-call"></i>
          </Link>
